...
class ParCorr(CondIndTest):
    ...
    **kwargs :
    ...
    def get_dependence_measure(self, array, xyz):
        ...
        corr = stats.pearsonr(x_vals, y_vals)
        val = corr[0]
        lower = round(corr.confidence_interval(0.95)[0],4)
        high = round(corr.confidence_interval(0.95)[1],4)
        print(round(val,4),lower,high)
        return val
